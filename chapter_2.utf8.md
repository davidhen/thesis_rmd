...
\begin{tabular}{@{}ll@{}}
\toprule
\multicolumn{1}{c}{\textbf{Stages of candidacy}} & \multicolumn{1}{c}{\textbf{Description of stage}} \\ \midrule
...
\begin{tabular}[c]{@{}l@{}}Appearing at services and \\ asserting candidacy\end{tabular} & \begin{tabular}[c]{@{}l@{}}The work that an individual must do to assert their candidacy in an interaction with \\ a health care professional\end{tabular} \\
Professional decision making & \begin{tabular}[c]{@{}l@{}}Candidacy as expressed by service user is validated or otherwise by service professional.\\ This influences future offers of service\end{tabular} \\
  ...
  \centering
    ...
    \resizebox{\textwidth}{!}{%
      \begin{threeparttable}
        ...
        Bureaucratic & \begin{tabular}[c]{@{}l@{}}Public services "run" by the middle classes therefore exert         influence \\ over how it is accessed and by whom.\end{tabular} \\ \hline
        \end{tabular}%
      \begin{tablenotes}
...
These findings were in agreement with eariler research by Tudor-Hart [-@RN37] who defined an "inverse care law" suggesting general practice resources had a larger concentration in more affluent areas (more fully discussed in section \ref{subsec:health-inequals}). 
