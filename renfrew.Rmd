...
When comparing the intensity of packages, the median value of total hours of home care tends to be higher in packages not captured by the census (figures \ref{fig:renf-intensity-type} and \ref{fig:renf-intensity-duration}. However the  


\begin{figure}[]
  \centering
    \caption{Variation in intensit of package (hrs) - by type}
...
\begin{figure}[]
  \centering
    \caption{Variation in intensity (hrs) - by duration}
    \includegraphics[height = 10cm, width = 12cm]{figures/chapter-renf/10-intensity-duration.png}
    \label{fig:renf-intensity-duration}
\end{figure}
