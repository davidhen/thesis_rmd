...
For packages captured in the census between the years 2011/12 and 2014/15 between 39.4% and 50.3% were the only package of care an individual received in the six months prior and following the census week. The remaning packages were received by individuals with more than one package of care in the same time period. 

Single packages of care tended to be of much longer duration than seen across the whole dataset with a median value of between 105 and 139 weeks across years (table \ref{tab:renf-single-cen-distribution} and figure \ref{fig:renf-single-cen-distribution}). Indeed, three-quarters of packages lasted for between 75 and 84.5 weeks across each financial year.

\begin{table}[]
\centering
\caption{Summary statistics of package duration for single packages of care captured by census}
\label{tab:renf-single-cen-distribution}
\resizebox{\textwidth}{!}{%
\begin{tabular}{@{}lllllll@{}}
\toprule
Financial Year & Packages (n) & Packages (\%) & 25th percentile & Median & 75th Percentile & IQR \\ \midrule
...
\begin{figure}[]
  \centering
    \caption{Distribution of package duration for single packages included in census}
    \includegraphics[height = 10cm, width = 12cm]{figures/chapter-renf/15-census-singles-length.png}
    \label{fig:renf-single-cen-distribution}
\end{figure}

The variation in the net difference in total hours of homecare received by individuals who had one of a number of packages received in the 12 months surrounding the census captured in the census week is shown in figure \ref{fig:renf-multiple-cen-netdiff} and table \ref{tab:renf-multi-cen-netdiff}. Whilst there are some outlying points in every year, median values are close to zero with the interquartile range varying from 6.3 to 9.5 hours. 

\begin{figure}[]
  \centering
    \caption{Distribution of net difference in hours of home care for multi packages included in census}
    \includegraphics[height = 10cm, width = 12cm]{figures/chapter-renf/16-census-multiples-netdiff.png}
    \label{fig:renf-multiple-cen-netdiff}
\end{figure}


**Need to add a individuals (n) column to this table**

\begin{table}[]
\centering
\caption{Summary statistics for distribution of net difference in hours of home care for multi-packages included in the census}
\label{tab:renf-multi-cen-netdiff}
\resizebox{\textwidth}{!}{%
\begin{tabular}{@{}lrrrrrrrrr@{}}
\toprule
\textbf{Financial Year} & \multicolumn{1}{l}{\textbf{Packages (n)}} & \multicolumn{1}{l}{\textbf{Packages (\%)}} & \multicolumn{1}{l}{\textbf{25th Percentile}} & \multicolumn{1}{l}{\textbf{Median}} & \multicolumn{1}{l}{\textbf{75th Percentile}} & \multicolumn{1}{l}{\textbf{IQR}} & \multicolumn{1}{l}{\textbf{Min}} & \multicolumn{1}{l}{\textbf{Max}} & \multicolumn{1}{l}{\textbf{Range}} \\ \midrule
...
\begin{figure}[]
  \centering
    ...
    \includegraphics{figures/chapter-renf/13-comb-intensity-type.png}
