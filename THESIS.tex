...
(2017, ch.20)). With data in this format, summary measures were derived
by applying functions to the list column utilising the \texttt{purrr} R
package (Henry and Wickham, 2017). Derived information included counts
of total USC episodes, acute admissions to hospital, A \& E attendances,
and total number of long-term conditions identified from admissions and
A \& E data. The format of the cleaned UCD data frame is described in
Table \ref{tab:USC-clean}
...
age for each individual revealed 8,809 observations with a null value.
...
excellent model fit (McFadden, 1977, p35; Louviere \emph{et al.}, 2000,
p55).
...
specific value of \(x_1\). Williams (2012,p325) provides an intuitive
example of how APEs are calculated and interpreted which has been
adapted to reflect the fitted model and uses the ``sex'' variable as an
example here
...
groups, together representing \textasciitilde{}58\% of the overall
cohort, are compared in relation to research question 1 in the first two
...
showed very strong effects (\textasciitilde{}40\%,
\textasciitilde{}28\%, and \textasciitilde{}15\% higher probability of
receiving social care across all models).
...
\textasciitilde{}15\% higher probability of receiving social care
compared to those receiving 0-2 repeat medicines in all years (15.3\% in
...
respectively \textasciitilde{}7\% and \textasciitilde{}3\% increased
...
\textasciitilde{}4\% compared to males for all models (exactly 4\% in
...
financial year was associated with a \textasciitilde{}7.5\% increase in
...
\textasciitilde{}6.5\% increase in the probability of having an
unplanned hospital admission compared to those with no social care.
There was a split in the direction of the effect of living in a care
home after 2013/14. After this year being in a care home was associated
with a decrease in the probability of unplanned admission of almost 1\%
whilst in previous years the probability had increased by almost 1\%.
...
small (\textless{}1\%) increase in probability of unplanned admission.
...
\ref{ch:renfrew} identifies, the \textasciitilde{}60\% of individuals
that the SCS would have identified as receiving home care in the
Renfrewshire area is likely to be an underestimate of the coverage of
total social care for the models in chapter \ref{ch:res2} for two
reasons.
...
(\textasciitilde{}1.1 million individuals) and linking their data from a
...
(\textasciitilde{}10,000, the smallest mainland local authority) were
not included in analysis due to poor linkage rates of social care data
to the population spine.
...
\href{http://www.ncbi.nlm.nih.gov/pmc/articles/PMC3315139/pdf/0100134.pdf\%0Ahttp://www.annfammed.org/content/10/2/134.full.pdf}{http://www.ncbi.nlm.nih.gov/pmc/articles/PMC3315139/pdf/0100134.pdf
...
Leeper, T., Arnold, J. and Arel-Bundock, V. (2017) \emph{Margins:
...
at:
\href{Moving\%20towards\%20integrated\%20working\%20in\%20health\%20and\%20social\%20care\%20in\%20Scotland:\%20from\%20maze\%20to\%20matrix}{Moving towards integrated working in health and social care in Scotland: from maze to matrix}.
...
Zeileis, A., Grothendieck, G. and Ryan, J. \emph{et al.} (2018)
