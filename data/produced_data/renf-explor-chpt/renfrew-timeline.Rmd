...
```{r timeline, echo=FALSE, fig.height = 3, fig.width=12, warning=FALSE}
library(ggplot2)
library(dplyr)
library(ggalt)
library(cowplot)
...
p1 <- data %>% 
  ...
  theme(axis.title = element_blank(),
        ...
        plot.caption = element_text(size = 10, colour = "#808080")) +
  expand_limits(x = c(ymd(20151201), ymd(20180601)), y = c(1.2, -0.6)) +
  scale_x_date(breaks = scales::pretty_breaks(n = 10)) +
  labs(caption = "UBDC = Urban Big Data Centre\nRAC = Research Approvals Committee\nDSA = Data Sharing Agreement")

#and run the function from above
timeline <- shift_axis(p1, ymd(20151201), ymd(20180701))
timeline
ggsave("/Users/hedgi/OneDrive - University of Glasgow/GitHub/thesis_rmd/figures/chapter-renf/renf-timeline.png", timeline, height = 3, width = 12,
       dpi = 600)
