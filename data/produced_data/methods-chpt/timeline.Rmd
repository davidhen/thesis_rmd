...
data <- tribble( ~start_date, ~event, ~displ,
                ...
                ymd(20160315), "1st year review", -0.5,
                ymd(20160524), "Ethical Approval", 0.5,
                ymd(20160712), "RAC approval", 0.3,
                ymd(20160831), "HSCAD confirms will link SCS", 0.15,
...
cond_colour <- 
  case_when(data$start_date == "2015-10-01" | 
              ...
              data$start_date == "2016-08-31" ~ "black",
...
p1 <- data %>% 
  ...
  expand_limits(x = c(ymd(20151201), ymd(20190301)), y = c(1.2, -1.2)) +
  scale_x_date(breaks = scales::pretty_breaks(n = 12))

#and run the function from above
timeline <- shift_axis(p1, ymd(20151001), ymd(20190401))
timeline <- timeline + 
  annotate("text", x = ymd(20160201), y = -1, label = "Renfrewshire Project", colour = "red") +
  annotate("text", x = ymd(20160201), y = -1.2,   label = "Main Project", colour = "blue")
