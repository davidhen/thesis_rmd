...
\item Definitions
\item Measures
\item MM and Health Inequalities
\end{itemize}

\subsection{Context}\label{subsec:litrv-mm-context}

At first sight, the definition of multimorbidity as the presence of two or more health conditions in one individual appears clear and concise. In fact, there are many competing concepts and definitions of multimorbidity in research literature resulting in confusing messages on epidemiology, measurement, and treatment [@RN570; @RN89; @RN95; @RN77]. One systematic review found the prevalance of multimorbidty in the general population to vary between 13.1% - 71.8% in studies where different definitions had been employed [@RN56].

Despite this, there is a concensus that multimorbidity is associated with a number of negative outcomes including: higher mortality [@RN81], reduced quality-of-life and functional status [@RN241; @RN242; @RN40], and increased psychological distress [@RN243]. All of these are likely contributors to the association of multimorbidity with increased use of healthcare services [@RN81; @RN22].
...
One potential solution to improve the efficiency of healthcare delivery is to focus resorces in community and primary care services rather than expensive secondary care [@RN320]. It has been argued that primary care services delivering continuity of care can foster preventative, cost-effective measures for those with, or at risk of developing, multimorbidity [@RN599].   

Touch on inequalities

research priorites - inc Mair

Paucity of impact on social care services

but first will talk about defs and epi, measurement, and health inequals in more detail. 
