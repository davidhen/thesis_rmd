...
```{r load}
pack_table <- read_csv(file = "/GitHub/thesis_rmd/figures/chapter-renf/census-pack-count.csv")
```
##Summarise
...
write_csv(pack_table_total, path = "/GitHub/thesis_rmd/data/produced_data/renf-explor-chpt/census_pack_count_tidy.csv")
```
