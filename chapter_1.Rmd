...
The thesis has both substantive and methodological aims. Substantively, it aims to contibute to the debate surrounding health and socila care integration by looking specifically at a group that are likely to be regular users of both health and social care services, i.e. those with multimorbidity. Methodologically, the thesis aims to contibute to efforts to improve the exploitation of administrative data as a means to analyse public service performance and effectiveness. 
...
4.  To assess tho what extant measures of multimorbidity and of health and social care service use can be operationalised using exisitng linked health and social care administrative data.
