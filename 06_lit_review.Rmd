...
IN the UK there is an important difference between social care and health care funding and access. Health care is universally provided free at the point of need by the NHS. Social care is commissioned by local, rather than central, government and is means and needs-tested [@RN173; @RN250], although there are many areas where the services overlap [@RN510]. These arrangements are poorly understood by the public, many of whom only find out they are required to pay for social care at the moment they first need it [@RN250; @RN535]. 
...
The second definition provided by Colombo et al[-@RN414] classifies social care as:- 
...
In a report for the OECD, Colombo et al [-@RN414] categorised the varying models of social care employed internationally into three main groups with subdivisions as shown in Table \ref{tab:oecd-soc-care}. 
...
\subsubsection{Overview}\label{subsubsec:sc-elig-overview}
...
\subsubsection{Financial constraints}\label{subsubsec:sc-elig-finance}
